...
async function loadEventRow(eventId: string) {
  const [row] = await db
    .select({
      ...
      bannerMobilePath: events.bannerMobilePath,
      headerColor: events.headerColor,
      ...
      conventionHeaderColor: conventions.headerColor,
      conventionBannerPath: conventions.bannerPath,
      conventionBannerMobilePath: conventions.bannerMobilePath,
